      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-7 col-sm-offset-3 form-box">
            <div class="form-top bg-success">
              <div class="form-top-left">
                <h3>Intranet Mantenimiento</h3>
            ...
            <div class="form-bottom">
              <form id="id_form" action="login" method="post" class="login-form">
                <div class="form-group">
                  <label class="sr-only" for="form-username">Usuario</label> <input
                    type="text" name="loginuser" placeholder="Usuario..."
                    value="" class="form-username form-control"
                    id="form-username">
                </div>
                <div class="form-group">
